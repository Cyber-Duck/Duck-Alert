...
public class ExternedBlockHost
{
    ...
    public static native void callUno_Fuse_Internal_AndroidSystemFont_AddFont54(final String path,final int weight,final boolean isItalic);
    ...
    {
        com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.AddJavascriptInterface225(handle,name,resultHandler);
    }
    
    public static boolean CanGoBack226(final Object handle)
    {
        return (boolean) com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.CanGoBack226(handle);
    }
    
    public static boolean CanGoForward227(final Object handle)
    {
        return (boolean) com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.CanGoForward227(handle);
    }
    ...
    {
        return (Object) com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.CreateAndSetWebChromeClient228(webViewHandle,onProgress);
    }
    ...
    {
        return (Object) com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.CreateAndSetWebViewClient229(webViewHandle,loaded,started,changed);
    }
    
    public static Object CreateWebView230()
    {
        return (Object) com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.CreateWebView230();
    }
    
    public static double GetProgress231(final Object handle)
    {
        return (double) com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.GetProgress231(handle);
    }
    
    public static String GetTitle232(final Object handle)
    {
        return (String) com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.GetTitle232(handle);
    }
    
    public static String GetUrl233(final Object handle)
    {
        return (String) com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.GetUrl233(handle);
    }
    
    public static void GoBack234(final Object handle)
    {
        com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.GoBack234(handle);
    }
    
    public static void GoForward235(final Object handle)
    {
        com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.GoForward235(handle);
    }
    
    public static void LoadHtml236(final Object handle,final String html,final String baseUrl)
    {
        com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.LoadHtml236(handle,html,baseUrl);
    }
    
    public static void LoadUrl237(final Object handle,final String url)
    {
        com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.LoadUrl237(handle,url);
    }
    
    public static void Reload238(final Object handle)
    {
        com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.Reload238(handle);
    }
    
    public static void StopLoading239(final Object handle)
    {
        com.foreign.Fuse.Android.Controls.WebViewUtils.WebViewForeign.StopLoading239(handle);
    }
    
    public static void ClearRootView240(final Object handle)
    {
        com.foreign.Fuse.Android.AppRoot.ClearRootView240(handle);
    }
    
    public static native void callUno_Fuse_Android_AppRoot_OnTouchEvent__242(final Object motionEvent,long motionEventPtr);
    public static Object CreateRootView241()
    {
        return (Object) com.foreign.Fuse.Android.AppRoot.CreateRootView241();
    }
    
    public static void SetChildSize1243(final Object handle,final int w,final int h)
    {
        com.foreign.Fuse.Android.AppRoot.SetChildSize1243(handle,w,h);
    }
    
    public static void SetRootView244(final Object handle,final Object rootHandle)
    {
        com.foreign.Fuse.Android.AppRoot.SetRootView244(handle,rootHandle);
    }
    
    public static Object CreateBitmapARGB8888Impl245(final int width,final int height)
    {
        return (Object) com.foreign.Fuse.Android.Bitmap.CreateBitmapARGB8888Impl245(width,height);
    }
    
    public static void EraseColor1246(final Object handle,final int color)
    {
        com.foreign.Fuse.Android.Bitmap.EraseColor1246(handle,color);
    }
    
    public static void Recycle1247(final Object handle)
    {
        com.foreign.Fuse.Android.Bitmap.Recycle1247(handle);
    }
    
    public static Object Create248(final Object bitmapHandle)
    {
        return (Object) com.foreign.Fuse.Android.Canvas.Create248(bitmapHandle);
    }
    
    public static void Translate1249(final Object handle,final float dx,final float dy)
    {
        com.foreign.Fuse.Android.Canvas.Translate1249(handle,dx,dy);
    }
    
    public static void TexImage2D250(final int target,final int level,final Object bitmap,final int border)
    {
        com.foreign.Fuse.Android.GLUtils.TexImage2D250(target,level,bitmap,border);
    }
    ...
    {
        return (Object) com.foreign.Fuse.Android.StaticLayout.Create251(text,bufStart,bufEnd,paintHandle,outerWidth,align,spacingMult,spacingAdd,includePad,truncateAt,ellipsizedWith);
    }
    ...
    {
        return (Object) com.foreign.Fuse.Android.StaticLayout.Create1252(text,paintHandle,width,align,spacingMult,spacingAdd,includePad);
    }
    
    public static void Draw1253(final Object layoutHandle,final Object canvasHandle)
    {
        com.foreign.Fuse.Android.StaticLayout.Draw1253(layoutHandle,canvasHandle);
    }
    
    public static float GetDesiredWidthImpl254(final String text,final Object paintHandle)
    {
        return (float) com.foreign.Fuse.Android.StaticLayout.GetDesiredWidthImpl254(text,paintHandle);
    }
    
    public static int GetEllipsizedWidth255(final Object handle)
    {
        return (int) com.foreign.Fuse.Android.StaticLayout.GetEllipsizedWidth255(handle);
    }
    
    public static int GetHeight256(final Object handle)
    {
        return (int) com.foreign.Fuse.Android.StaticLayout.GetHeight256(handle);
    }
    
    public static int GetLineBaseline1257(final Object handle,final int line)
    {
        return (int) com.foreign.Fuse.Android.StaticLayout.GetLineBaseline1257(handle,line);
    }
    
    public static int GetLineCount258(final Object handle)
    {
        return (int) com.foreign.Fuse.Android.StaticLayout.GetLineCount258(handle);
    }
    
    public static int GetLineEnd1259(final Object handle,final int line)
    {
        return (int) com.foreign.Fuse.Android.StaticLayout.GetLineEnd1259(handle,line);
    }
    
    public static float GetLineLeft1260(final Object handle,final int line)
    {
        return (float) com.foreign.Fuse.Android.StaticLayout.GetLineLeft1260(handle,line);
    }
    
    public static int GetLineStart1261(final Object handle,final int line)
    {
        return (int) com.foreign.Fuse.Android.StaticLayout.GetLineStart1261(handle,line);
    }
    
    public static int GetWidth262(final Object handle)
    {
        return (int) com.foreign.Fuse.Android.StaticLayout.GetWidth262(handle);
    }
    
    public static int GetStatusBarColor263()
    {
        return (int) com.foreign.Fuse.Android.StatusBarHelper.GetStatusBarColor263();
    }
    
    public static native void callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar265();
    public static void InstallGlobalListener264()
    {
        com.foreign.Fuse.Android.StatusBarHelper.InstallGlobalListener264();
    }
    
    public static void SetStatusBarColor266(final int color)
    {
        com.foreign.Fuse.Android.StatusBarHelper.SetStatusBarColor266(color);
    }
    
    public static Object Create267()
    {
        return (Object) com.foreign.Fuse.Android.TextPaint.Create267();
    }
    
    public static void GetTextBounds268(final Object handle,final String text,final int start,final int end,final com.uno.IntArray r)
    {
        com.foreign.Fuse.Android.TextPaint.GetTextBounds268(handle,text,start,end,r);
    }
    
    public static void SetAntiAlias269(final Object handle,final boolean value)
    {
        com.foreign.Fuse.Android.TextPaint.SetAntiAlias269(handle,value);
    }
    
    public static void SetColor270(final Object handle,final int color)
    {
        com.foreign.Fuse.Android.TextPaint.SetColor270(handle,color);
    }
    
    public static void SetTextSize271(final Object handle,final float textSize)
    {
        com.foreign.Fuse.Android.TextPaint.SetTextSize271(handle,textSize);
    }
    
    public static void SetTypeface272(final Object paintHandle,final Object typefaceHandle)
    {
        com.foreign.Fuse.Android.TextPaint.SetTypeface272(paintHandle,typefaceHandle);
    }
    
    public static String GetCacheDirectory273()
    {
        return (String) com.foreign.Fuse.FileSystem.AndroidPaths.GetCacheDirectory273();
    }
    
    public static String GetExternalCacheDirectory274()
    {
        return (String) com.foreign.Fuse.FileSystem.AndroidPaths.GetExternalCacheDirectory274();
    }
    
    public static String GetExternalFilesDirectory275()
    {
        return (String) com.foreign.Fuse.FileSystem.AndroidPaths.GetExternalFilesDirectory275();
    }
    
    public static String GetFilesDirectory276()
    {
        return (String) com.foreign.Fuse.FileSystem.AndroidPaths.GetFilesDirectory276();
    }
    
    public static String GetCacheDirectory277()
    {
        return (String) com.foreign.Fuse.FileSystem.UnifiedPaths.GetCacheDirectory277();
    }
    
    public static String GetDataDirectory278()
    {
        return (String) com.foreign.Fuse.FileSystem.UnifiedPaths.GetDataDirectory278();
    }
    
    public static void cacheBundle279(final Object _bundle)
    {
        com.foreign.Fuse.PushNotifications.AndroidImpl.cacheBundle279(_bundle);
    }
    
    public static native int callUno_Fuse_PushNotifications_AndroidImpl_PLAY_SERVICES_RESOLUTION_REQUESTGet281();
    public static boolean CheckPlayServices280()
    {
        return (boolean) com.foreign.Fuse.PushNotifications.AndroidImpl.CheckPlayServices280();
    }
    
    public static String GetPayloadFromBundle282(final Object _bundle)
    {
        return (String) com.foreign.Fuse.PushNotifications.AndroidImpl.GetPayloadFromBundle282(_bundle);
    }
    
    public static native void callUno_Fuse_PushNotifications_AndroidImpl_OnRecieve284(final Object bundle,long bundlePtr);
    public static native String callUno_Fuse_PushNotifications_AndroidImpl__senderIDGet285();
    public static native void callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdSuccess286(final String regid);
    public static native void callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdError287(final String message);
    public static void JInit283()
    {
        com.foreign.Fuse.PushNotifications.AndroidImpl.JInit283();
    }
    
    public static void NoteInteractivity288(final boolean isItInteractive)
    {
        com.foreign.Fuse.PushNotifications.AndroidImpl.NoteInteractivity288(isItInteractive);
    }
    
    public static void NotificationFromJson289(final Object listener,final String _jsonStr,final Object _bundle)
    {
        com.foreign.Fuse.PushNotifications.AndroidImpl.NotificationFromJson289(listener,_jsonStr,_bundle);
    }
    ...
    {
        com.foreign.Fuse.PushNotifications.AndroidImpl.SpitOutNotification290(_listener,title,body,sound,_payload);
    }
    
    public static void ClearAllNotifications291()
    {
        com.foreign.Fuse.PushNotifications.PushNotify.ClearAllNotifications291();
    }
    
    public static native String callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet292();
    public static native void callUno_Fuse_LocalNotifications_AndroidImpl_NotificationRecieved293(final String payload);
    public static void JInit()
    {
        com.foreign.Fuse.LocalNotifications.AndroidImpl.JInit();
    }
    
    public static native int callUno_Fuse_LocalNotifications_AndroidImpl_NextID295();
    ...
    {
        com.foreign.Fuse.LocalNotifications.AndroidImpl.Later294(title,body,sound,strPayload,delaySeconds);
    }
    
    public static void NoteInteractivity(final boolean isItInteractive)
    {
        com.foreign.Fuse.LocalNotifications.AndroidImpl.NoteInteractivity(isItInteractive);
    }
    
    public static void OnNotificationRecieved(final Object _context,final Object _intent)
    {
        com.foreign.Fuse.LocalNotifications.AndroidImpl.OnNotificationRecieved(_context,_intent);
    }
    
    public static void ClearAllNotifications296()
    {
        com.foreign.Fuse.LocalNotifications.Notify.ClearAllNotifications296();
    }
    
    public static int GetBuildVersion297()
    {
        return (int) com.foreign.Fuse.AndroidProperties.GetBuildVersion297();
    }
    
    public static String GetReleaseVersion298()
    {
        return (String) com.foreign.Fuse.AndroidProperties.GetReleaseVersion298();
    }
    
    public static native void callUno_Fuse_App_OnFrameCallback300(final UnoObject jthis,final double currentTime,final double deltaTime);
    public static void StartFrameCallback299(final UnoObject _this)
    {
        com.foreign.Fuse.App.StartFrameCallback299(_this);
    }
    
    public static String GetGUID301()
    {
        return (String) com.foreign.Outracks.Simulator.DeviceInfo.GetGUID301();
    }
    
    public static String GetName302()
    {
        return (String) com.foreign.Outracks.Simulator.DeviceInfo.GetName302();
    }
