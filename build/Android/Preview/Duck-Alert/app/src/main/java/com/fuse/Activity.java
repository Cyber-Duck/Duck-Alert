...
//    #endif
    {
        return com.apps.duckalert.DuckAlert.RootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.apps.duckalert.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.apps.duckalert.DuckAlert activity = (com.apps.duckalert.DuckAlert)getRootActivity();
