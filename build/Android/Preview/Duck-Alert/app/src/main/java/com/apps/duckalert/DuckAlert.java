...
//#else
public class DuckAlert extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
//#endif
{
...
//#endif
    ...
    {
    	DuckAlert activity = _appState.CurrentActivity;
...
//#endif
    ...
    public static DuckAlert RootActivity()
    {
        return _appState.CurrentActivity;
    }
