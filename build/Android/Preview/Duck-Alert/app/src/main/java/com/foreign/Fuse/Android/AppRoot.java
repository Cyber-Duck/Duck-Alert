...
public class AppRoot
{
    ...
    {
        android.widget.RelativeLayout relativeLayout = new android.widget.RelativeLayout(com.apps.duckalert.DuckAlert.GetRootActivity()) {
        					...
        					public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        						...
        						ExternedBlockHost.callUno_Fuse_Android_AppRoot_OnTouchEvent__242((Object)motionEvent,UnoHelper.GetUnoObjectRef((Object)motionEvent));
