...
// /usr/local/share/uno/Packages/Fuse.Drawing.Batching/0.40.8/$.uno
// ----------------------------------------------------------------
...
static void MeshBatcher_build(uType* type)
{
    ...
    ::TYPES[11] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Fuse::Drawing::Batching::Entry_typeof(), ::g::Uno::Content::Models::ModelMesh_typeof());
    ::TYPES[12] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Drawing::Batching::Entry_typeof(), ::g::Uno::Content::Models::ModelMesh_typeof());
    type->SetFields(0,
