...
static void ImageLoader__ImageHandlePromise_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Threading::Future1_typeof()->MakeType(::g::Java::Object_typeof()));
    ::TYPES[1] = ::g::Uno::Threading::Promise_typeof()->MakeType(::g::Java::Object_typeof());
    ::TYPES[2] = ::g::Uno::Func_typeof()->MakeType(::g::Java::Object_typeof());
    ::TYPES[3] = ::g::Uno::Action1_typeof()->MakeType(::g::Java::Object_typeof());
    ::TYPES[4] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Threading::Future1_typeof()->MakeType(::g::Java::Object_typeof()));
...
{
    uStackFrame __("Fuse.Controls.Native.ImageLoader.ImageHandlePromise", "Download()");
...
{
    uStackFrame __("Fuse.Controls.Native.ImageLoader.ImageHandlePromise", "Download(string)");
    {
        INIT_JNI;
...
static void ImageLoader_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Fuse::Controls::Native::ImageHandle_typeof());
    ::TYPES[6] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ImageLoader__ImageHandlePromise_typeof());
    ::TYPES[7] = ::g::Uno::Threading::Promise_typeof()->MakeType(::g::Fuse::Controls::Native::ImageHandle_typeof());
...
static void ImageLoader__PendingPromise_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::Threading::Future_type, interface0));
    type->SetFields(9,
        ::g::Uno::Threading::Future1_typeof()->MakeType(::g::Fuse::Controls::Native::ImageHandle_typeof()), offsetof(::g::Fuse::Controls::Native::ImageLoader__PendingPromise, _future), 0);
}
