...
// /usr/local/share/uno/Packages/Fuse.Platform/0.40.8/$.uno
// --------------------------------------------------------
...
static void AppEvents_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Action_typeof(), (uintptr_t)&::g::Fuse::Platform::AppEvents::LowMemoryWarning1_, uFieldFlagsStatic);
}
...
{
    uStackFrame __("Fuse.Platform.Display", "get_MainDisplay()");
