...
{
    uStackFrame __("Outracks.Simulator.Bytecode.AddEventHandler", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.BlobLiteral", "get_LiteralId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.BooleanLiteral", "get_LiteralId()");
...
static void CallDynamicMethod_build(uType* type)
{
    ...
    ::TYPES[8] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Expression_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->SetFields(0,
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.CallDynamicMethod", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.CallLambda", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.CallStaticMethod", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.EnumLiteral", "get_LiteralId()");
...
static void Expression_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(6,
        ...
        new uFunction("Write", NULL, (void*)Expression__Write1_fn, 0, true, uVoid_typeof(), 2, Expression_typeof(), ::g::Uno::IO::BinaryWriter_typeof()));
}
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.Expression", "get_StatementId()");
    return *__retval = 'e', void();
}
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.Instantiate", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.IsType", "get_ExpressionId()");
    return *__retval = 'e', void();
}
...
static void Lambda_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("\n"
        "}");
    ::TYPES[25] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::BindVariable_typeof());
    ::TYPES[26] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Statement_typeof());
    ::TYPES[27] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::BindVariable_typeof());
    ::TYPES[28] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Statement_typeof());
    ::TYPES[29] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[30] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::BindVariable_typeof());
    ::TYPES[31] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Statement_typeof());
    ::TYPES[32] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::BindVariable_typeof());
    ::TYPES[33] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Statement_typeof());
    ::TYPES[34] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Statement_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->SetFields(0,
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.Lambda", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.Literal", "get_ExpressionId()");
    return *__retval = 'b', void();
}
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.LogicalOr", "get_ExpressionId()");
...
static void MethodGroup_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const(")");
    ::TYPES[40] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Signature_typeof());
    ::TYPES[41] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Signature_typeof());
    ::TYPES[42] = ::g::Uno::Action2_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Signature_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->SetFields(0,
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.MethodGroup", "get_ExpressionId()");
    return *__retval = 'd', void();
}
...
{
    ::TYPES[43] = ::g::Uno::Action2_typeof()->MakeType(NamespaceName_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[44] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), NamespaceName_typeof());
    type->SetInterfaces(
...
static void NoOperation_build(uType* type)
{
    ...
    ::TYPES[45] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[46] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[47] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetFields(0,
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.NoOperation", "get_StatementId()");
    return *__retval = 'n', void();
}
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.NumberLiteral", "get_LiteralId()");
    return *__retval = 'n', void();
}
...
static void Parameter_build(uType* type)
{
    ...
    ::TYPES[51] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), Parameter_typeof());
    ::TYPES[52] = ::g::Uno::Action2_typeof()->MakeType(Parameter_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->SetFields(0,
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.ReadProperty", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.ReadStaticField", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.ReadVariable", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.RemoveEventHandler", "get_ExpressionId()");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.Return", "get_StatementId()");
...
static void Signature_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const(", ");
    ::STRINGS[8] = uString::Const(")");
    ::TYPES[53] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), Signature_typeof());
    ::TYPES[54] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Parameter_typeof());
    ::TYPES[55] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    ::TYPES[56] = ::g::Outracks::Simulator::Bytecode::Parameter_typeof()->Array();
    ::TYPES[57] = ::g::Outracks::Simulator::ImmutableList_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::Parameter_typeof());
    ::TYPES[58] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    ::TYPES[59] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    ::TYPES[60] = ::g::Uno::String_typeof()->Array();
    ::TYPES[61] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[62] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::Parameter_typeof());
    ::TYPES[63] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    type->SetFields(0,
...
static void Statement_build(uType* type)
{
    ...
    ::TYPES[64] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), Statement_typeof());
    ...
    ::TYPES[68] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[69] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(Statement_typeof());
    ::TYPES[70] = Statement_typeof()->Array();
    ::TYPES[71] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, Statement_typeof());
    type->SetFields(0,
    ...
    type->Reflection.SetFunctions(6,
        ...
        new uFunction("Write", NULL, (void*)Statement__Write_fn, 0, true, uVoid_typeof(), 2, Statement_typeof(), ::g::Uno::IO::BinaryWriter_typeof()));
}
...
static void StringLiteral_build(uType* type)
{
    ...
    ::TYPES[45] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[72] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), ::g::Uno::String_typeof());
    ::TYPES[68] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[73] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[74] = ::g::Outracks::Simulator::Bytecode::OptionalExtensions_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[75] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    type->SetFields(0,
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.StringLiteral", "get_LiteralId()");
...
static void TypeName_build(uType* type)
{
    ...
    ::TYPES[76] = ::g::Uno::Action2_typeof()->MakeType(TypeName_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[77] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), TypeName_typeof());
    ::TYPES[55] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[78] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[63] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[79] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[80] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[81] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(TypeName_typeof());
    ::TYPES[58] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(TypeName_typeof());
    ::TYPES[82] = ::g::Uno::Collections::List_typeof()->MakeType(TypeName_typeof());
    ::TYPES[83] = ::g::Outracks::Simulator::StringSplitting_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[59] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, TypeName_typeof());
    ::TYPES[84] = ::g::Outracks::Simulator::ImmutableList_typeof()->MakeType(TypeName_typeof());
    type->SetInterfaces(
        ::g::Outracks::Simulator::IEquatable_typeof()->MakeType(TypeName_typeof()), offsetof(TypeName_type, interface0));
    type->SetFields(0,
        ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(TypeName_typeof()), (uintptr_t)0, uFieldFlagsConstrained,
    ...
    type->Reflection.SetFunctions(12,
        ...
        new uFunction("get_GenericArgumentsRecursively", NULL, (void*)TypeName__get_GenericArgumentsRecursively_fn, 0, false, ::g::Outracks::Simulator::ImmutableList_typeof()->MakeType(TypeName_typeof()), 0),
        ...
        new uFunction(".ctor", NULL, (void*)TypeName__New1_fn, 0, true, TypeName_typeof(), 3, ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(TypeName_typeof()), ::g::Uno::String_typeof(), ::g::Outracks::Simulator::ImmutableList_typeof()->MakeType(TypeName_typeof())),
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.TypeName", ".ctor(Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Bytecode.TypeName>,string,Outracks.Simulator.ImmutableList<Outracks.Simulator.Bytecode.TypeName>)");
...
static void TypeNameParser_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const(",");
    ::TYPES[58] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    ::TYPES[80] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    ::TYPES[82] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::TypeName_typeof());
    type->SetFields(0,
        ::g::Uno::Int_typeof(), offsetof(::g::Outracks::Simulator::Bytecode::TypeNameParser, _idx), 0,
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof()), offsetof(::g::Outracks::Simulator::Bytecode::TypeNameParser, _tokens), 0);
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", NULL, (void*)TypeNameParser__New1_fn, 0, true, TypeNameParser_typeof(), 1, ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof())),
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.TypeNameParser", ".ctor(Uno.Collections.List<string>)");
    _tokens = tokens;
}
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.TypeNameParser", "get_NoTypes()");
...
static void TypeNameTokenizer_build(uType* type)
{
    ...
    ::STRINGS[31] = uString::Const(">");
    ::STRINGS[30] = uString::Const(",");
    ::TYPES[85] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetFields(0,
        ...
        ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof()), offsetof(::g::Outracks::Simulator::Bytecode::TypeNameTokenizer, _tokens), 0);
    type->Reflection.SetFunctions(2,
        new uFunction("IsSpecialChar", NULL, (void*)TypeNameTokenizer__IsSpecialChar_fn, 0, true, ::g::Uno::Bool_typeof(), 1, ::g::Uno::Char_typeof()),
        new uFunction("Tokenize", NULL, (void*)TypeNameTokenizer__Tokenize1_fn, 0, true, ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof()), 1, ::g::Uno::String_typeof()));
}
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.TypeNameTokenizer", ".ctor(string)");
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.TypeNameTokenizer", "IsSpecialChar(char)");
    return (((c == '.') || (c == '<')) || (c == '>')) || (c == ',');
}
...
static void Variable_build(uType* type)
{
    ...
    ::TYPES[86] = ::g::Uno::Action2_typeof()->MakeType(Variable_typeof(), ::g::Uno::IO::BinaryWriter_typeof());
    ::TYPES[87] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), Variable_typeof());
    type->SetInterfaces(
...
{
    uStackFrame __("Outracks.Simulator.Bytecode.WriteProperty", "get_ExpressionId()");
