...
jboolean JNICALL callUno_Func_Object(JNIEnv *env,jclass clazz,jobject theDelegate,jobject arg,jlong argPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uDelegate* uno_theDelegate = uCast<uDelegate*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(theDelegate), ::g::Uno::Func1_typeof()->MakeType(::g::Java::Object_typeof(), ::g::Uno::Bool_typeof()));
...
jint JNICALL callUno_Fuse_LocalNotifications_AndroidImpl_NextID295(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
    JTRY
        int __result=::g::Fuse::LocalNotifications::AndroidImpl::NextID();
        __jresult = (jint)__result;
    JCATCH
    return __jresult;
}
jint JNICALL callUno_Fuse_PushNotifications_AndroidImpl_PLAY_SERVICES_RESOLUTION_REQUESTGet281(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jobject JNICALL callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet292(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
    JTRY
        uString* __result=::g::Fuse::LocalNotifications::AndroidImpl::ACTION();
        __jresult = (__result==NULL ? NULL : U_JNIVAR->NewLocalRef((JniHelper::UnoToJavaString(__result))));
    JCATCH
    return __jresult;
}
jobject JNICALL callUno_Fuse_PushNotifications_AndroidImpl__senderIDGet285(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
void JNICALL callUno_Fuse_Android_AppRoot_OnTouchEvent__242(JNIEnv *env,jclass clazz,jobject motionEvent,jlong motionEventPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_motionEvent = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(motionEvent, true);
...
void JNICALL callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar265(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_App_OnFrameCallback300(JNIEnv *env,jclass clazz,jobject jthis,jdouble currentTime,jdouble deltaTime)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddFont54(JNIEnv *env,jclass clazz,jobject path,jint weight,jboolean isItalic)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ...
    JTRY
        ::g::Fuse::Internal::AndroidSystemFont::AddFont(uCast<uString*>(uno_path, ::g::Uno::String_typeof()), uno_weight, uno_isItalic);
    JCATCH
}
...
void JNICALL callUno_Fuse_LocalNotifications_AndroidImpl_NotificationRecieved293(JNIEnv *env,jclass clazz,jobject payload)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_payload = JniHelper::JavaToUnoString((jstring)payload);
    JTRY
        ::g::Fuse::LocalNotifications::AndroidImpl::NotificationRecieved(uCast<uString*>(uno_payload, ::g::Uno::String_typeof()));
    JCATCH
}
void JNICALL callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdError287(JNIEnv *env,jclass clazz,jobject message)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_message = JniHelper::JavaToUnoString((jstring)message);
...
void JNICALL callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdSuccess286(JNIEnv *env,jclass clazz,jobject regid)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_PushNotifications_AndroidImpl_OnRecieve284(JNIEnv *env,jclass clazz,jobject bundle,jlong bundlePtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddFont54", (char* const)"(Ljava/lang/String;IZ)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddFont54},
    ...
    {(char* const)"callUno_Fuse_Android_AppRoot_OnTouchEvent__242", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Android_AppRoot_OnTouchEvent__242},
    {(char* const)"callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar265", (char* const)"()V", (void *)&callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar265},
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl_PLAY_SERVICES_RESOLUTION_REQUESTGet281", (char* const)"()I", (void *)&callUno_Fuse_PushNotifications_AndroidImpl_PLAY_SERVICES_RESOLUTION_REQUESTGet281},
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl_OnRecieve284", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_PushNotifications_AndroidImpl_OnRecieve284},
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl__senderIDGet285", (char* const)"()Ljava/lang/String;", (void *)&callUno_Fuse_PushNotifications_AndroidImpl__senderIDGet285},
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdSuccess286", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdSuccess286},
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdError287", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdError287},
    {(char* const)"callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet292", (char* const)"()Ljava/lang/String;", (void *)&callUno_Fuse_LocalNotifications_AndroidImpl_ACTIONGet292},
    {(char* const)"callUno_Fuse_LocalNotifications_AndroidImpl_NotificationRecieved293", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_Fuse_LocalNotifications_AndroidImpl_NotificationRecieved293},
    {(char* const)"callUno_Fuse_LocalNotifications_AndroidImpl_NextID295", (char* const)"()I", (void *)&callUno_Fuse_LocalNotifications_AndroidImpl_NextID295},
    {(char* const)"callUno_Fuse_App_OnFrameCallback300", (char* const)"(Lcom/uno/UnoObject;DD)V", (void *)&callUno_Fuse_App_OnFrameCallback300},
    };
    int funcCount = 88;
