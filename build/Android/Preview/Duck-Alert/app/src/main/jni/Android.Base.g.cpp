...
// /usr/local/share/uno/Packages/UnoCore/0.40.2/targets/android/uno/base/$.uno
// ---------------------------------------------------------------------------
...
{
    uStackFrame __("Android.Base.JNI", "GetStaticMethodID(Android.Base.Primitives.ujclass,string,string)");
    JNI_typeof()->Init();
    const char* cMethodName = uAllocCStr(methodName);
    const char* cMethodSig = uAllocCStr(methodSig);
