...
// /usr/local/share/uno/Packages/Fuse.Scripting.V8/0.40.8/$.uno
// ------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Scripting.V8.Array", ".ctor(Fuse.Scripting.V8.Context,Fuse.Scripting.V8.Simple.Array)");
    ctor_();
    _context = context;
    _array = array;
}
...
{
    uStackFrame __("Fuse.Scripting.V8.Marshaller.CallbackWrapper", ".ctor(Fuse.Scripting.V8.Context,Fuse.Scripting.Callback)");
    _context = context;
    _callback = callback;
}
...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.V8/0.40.8/$.uno");
...
void Debugger__Connected::ctor_(::g::Fuse::Scripting::V8::Debugger* parent, ::g::Uno::Net::Sockets::Socket* socket, ::g::Uno::IO::TextReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DEBUG_V8: C...*/], 1, ::STRINGS[1/*"/usr/local/...*/], 571);
    _parent = parent;
    _socket = socket;
    _reader = reader;
}
...
static void Debugger_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("0.40.8");
    ::STRINGS[23] = uString::Const("\r\n"
        "Content-Length: 0\r\n"
        "\r\n"
        "");
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[6] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[4] = ::g::Uno::Action_typeof();
    ::TYPES[14] = Debugger__State_typeof();
    ::TYPES[15] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetInterfaces(
...
uObject* Debugger::Connect(Debugger* parent)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[16/*"DEBUG_V8: W...*/], uBox<int>(::TYPES[17/*int*/], parent->_port)), ::STRINGS[17/*"..."*/]), 1, ::STRINGS[1/*"/usr/local/...*/], 419);
...
{
    uStackFrame __("Fuse.Scripting.V8.Function", ".ctor(Fuse.Scripting.V8.Context,Fuse.Scripting.V8.Simple.Function)");
    ctor_();
    _context = context;
    _function = function;
}
...
static void Marshaller_build(uType* type)
{
    ...
    ::TYPES[25] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Scripting::V8::Simple::UniqueValueVector_typeof(), ::g::Fuse::Scripting::V8::Simple::Value_typeof());
...
{
    uStackFrame __("Fuse.Scripting.V8.Object", ".ctor(Fuse.Scripting.V8.Context,Fuse.Scripting.V8.Simple.Object)");
    ctor_();
    _context = context;
    _object = obj;
}
