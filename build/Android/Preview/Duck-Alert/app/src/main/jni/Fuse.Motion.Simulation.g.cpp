...
// /usr/local/share/uno/Packages/Fuse.Motion/0.40.8/simulation/$.uno
// -----------------------------------------------------------------
...
static void BasicBoundedRegion2D_build(uType* type)
{
    ...
    ::TYPES[6] = ::g::Fuse::Motion::Simulation::ElasticForce_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[7] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[2] = ::g::Fuse::Motion::Simulation::Simulation_typeof();
    ::TYPES[8] = ::g::Fuse::Motion::Simulation::DestinationSimulation_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetInterfaces(
