...
// /usr/local/share/uno/Packages/UnoCore/0.40.2/source/uno/runtime/implementation/internal/$.uno
// ---------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Uno.Runtime.Implementation.Internal.ArrayEnumerator`1", "Reset()");
    _iterator = -1;
    _current().Default();
}
...
static void FormatStringTokenizer_build(uType* type)
{
    ...
    ::TYPES[14] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Runtime::Implementation::Internal::FormatStringToken_typeof());
    type->SetFields(0,
...
static void NumericFormatter_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::Bool_typeof();
    ::TYPES[13] = ::g::Uno::Double_typeof();
    ::TYPES[16] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Char_typeof());
    ::TYPES[11] = ::g::Uno::ULong_typeof();
    ::TYPES[8] = ::g::Uno::Int_typeof();
    ::TYPES[12] = ::g::Uno::Float_typeof();
