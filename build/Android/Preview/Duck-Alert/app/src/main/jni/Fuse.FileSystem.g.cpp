...
// /usr/local/share/uno/Packages/Fuse.FileSystem/0.40.8/$.uno
// ----------------------------------------------------------
...
uString* AndroidPaths::GetCacheDirectory()
{
    uStackFrame __("Fuse.FileSystem.AndroidPaths", "GetCacheDirectory()");
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetCacheDirectory273", "()Ljava/lang/String;");
...
uString* AndroidPaths::GetExternalCacheDirectory()
{
    uStackFrame __("Fuse.FileSystem.AndroidPaths", "GetExternalCacheDirectory()");
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetExternalCacheDirectory274", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
uString* AndroidPaths::GetExternalFilesDirectory()
{
    uStackFrame __("Fuse.FileSystem.AndroidPaths", "GetExternalFilesDirectory()");
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetExternalFilesDirectory275", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
uString* AndroidPaths::GetFilesDirectory()
{
    uStackFrame __("Fuse.FileSystem.AndroidPaths", "GetFilesDirectory()");
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetFilesDirectory276", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
// /usr/local/share/uno/Packages/Fuse.FileSystem/0.40.8/uno/io/$.uno
// -----------------------------------------------------------------
...
{
    uStackFrame __("Fuse.FileSystem.FileSystemModule", "GetCacheDirectory()");
...
{
    uStackFrame __("Fuse.FileSystem.FileSystemModule", "GetDataDirectory()");
...
// public FileSystemOperations New(Uno.Threading.IDispatcher dispatcher) :1010
...
// public FileSystemOperations New(Uno.Threading.IDispatcher dispatcher) [static] :1010
...
// private Nothing() :1322
void Nothing__ctor__fn(Nothing* __this)
{
    __this->ctor_();
}

// private Nothing New() :1322
void Nothing__New1_fn(Nothing** __retval)
{
    *__retval = Nothing::New1();
}

// private Nothing() [instance] :1322
void Nothing::ctor_()
{
}

// private Nothing New() [static] :1322
...
uString* UnifiedPaths::GetCacheDirectory()
{
    uStackFrame __("Fuse.FileSystem.UnifiedPaths", "GetCacheDirectory()");
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetCacheDirectory277", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
uString* UnifiedPaths::GetDataDirectory()
{
    uStackFrame __("Fuse.FileSystem.UnifiedPaths", "GetDataDirectory()");
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetDataDirectory278", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
