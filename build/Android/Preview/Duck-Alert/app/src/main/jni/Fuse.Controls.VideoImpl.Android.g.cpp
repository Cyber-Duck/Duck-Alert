...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/0.40.8/android/$.uno
// ----------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.Android.MediaPlayer", "OnEnteringBackground(Fuse.Platform.ApplicationState)");
    Pause();
}
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.Android.MediaPlayer", "get_RotationDegrees()");
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.Android.MediaPlayer", "GetOrientation(Java.Object)");
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
