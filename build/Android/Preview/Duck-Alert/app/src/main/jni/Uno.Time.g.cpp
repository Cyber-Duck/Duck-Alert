...
// /usr/local/share/uno/Packages/UnoCore/0.40.2/source/uno/time/$.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.40.2/source/uno/time/utilities/$.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.40.2/source/uno/time/timezones/$.uno
// ----------------------------------------------------------------------------
...
static void Instant_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("FromUtc", NULL, (void*)Instant__FromUtc_fn, 0, true, Instant_typeof(), 5, ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof()),
...
{
    ::TYPES[7] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::LocalDateTime_typeof());
    ::TYPES[2] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::Offset_typeof());
    type->SetFields(0,
...
static void ZonedDateTime_build(uType* type)
{
    ...
    ::TYPES[8] = ::g::Uno::Time::Preconditions_typeof()->MakeMethod(1, ::g::Uno::Time::DateTimeZone_typeof());
    ::TYPES[3] = ::g::Uno::Time::Preconditions_typeof()->MakeMethod(1, ::g::Uno::Time::CalendarSystem_typeof());
    ::TYPES[7] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::LocalDateTime_typeof());
    ::TYPES[2] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::Offset_typeof());
