...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() :1064
void Dns__GetLocalAddresses_fn(uArray** __retval)
{
    *__retval = Dns::GetLocalAddresses();
}

// private static extern bool JavaGetLocalAddresses(Uno.Collections.List<string> addresses) :1028
...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() [static] :1064
...
// private static extern bool JavaGetLocalAddresses(Uno.Collections.List<string> addresses) [static] :1028
