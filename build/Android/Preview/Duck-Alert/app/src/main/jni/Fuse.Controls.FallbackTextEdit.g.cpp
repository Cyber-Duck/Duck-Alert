...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.40.8/textcontrols/fallbacktextedit/$.uno
// -------------------------------------------------------------------------------------------------
...
static void LineCache_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Controls::FallbackTextEdit::LineCacheLine_typeof());
    type->SetFields(0,
...
{
    uStackFrame __("Fuse.Controls.FallbackTextEdit.LineCache", ".ctor(Uno.Action,Uno.Action,bool)");
    _isTextValid = true;
