...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/duckalert/DuckAlert");
    jclass entryPointsClass = env->FindClass("com/apps/duckalert/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/apps/duckalert/Display");
