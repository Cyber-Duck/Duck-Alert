...
// internal sealed extern class NativeViewRenderer :1506
// {
...
// public NativeViewRenderer(ObjC.Object viewHandle) :1513
void NativeViewRenderer__ctor__fn(NativeViewRenderer* __this, uObject* viewHandle)
{
    __this->ctor_(viewHandle);
}

// private void DeleteTexture() :1623
void NativeViewRenderer__DeleteTexture_fn(NativeViewRenderer* __this)
{
    __this->DeleteTexture();
}

// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) :1560
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) :1664
void NativeViewRenderer__FreePixelBuffer_fn(void** buffer)
{
    NativeViewRenderer::FreePixelBuffer(*buffer);
}

// private void Fuse.Controls.Native.INativeViewRenderer.Draw(float4x4 localToClipTransform, float2 position, float2 size, float density) :1519
...
// private void Fuse.Controls.Native.INativeViewRenderer.Invalidate() :1618
...
// private void Uno.IDisposable.Dispose() :1637
...
// public NativeViewRenderer(ObjC.Object viewHandle) [instance] :1513
...
// private void DeleteTexture() [instance] :1623
...
// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) [static] :1560
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) [static] :1664
...
// private static Uno.IntPtr MallocPixelBuffer(int size) [static] :1659
...
// public NativeViewRenderer New(ObjC.Object viewHandle) [static] :1513
