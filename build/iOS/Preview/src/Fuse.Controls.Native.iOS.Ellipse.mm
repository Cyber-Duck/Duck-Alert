...
{
    uStackFrame __("Fuse.Controls.Native.iOS.Ellipse", "CreatePath()");
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.Ellipse", ".ctor(Fuse.Visual)");
    ctor_1(visual);
}
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.Ellipse", "CreateUIBezierPath(float,float,float,float)");
    @autoreleasepool
    {
