...
static void FontCache_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Internal::FontFaceDescriptor_typeof(), ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Float_typeof(), ::g::ObjC::Object_typeof()));
    ::TYPES[1] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Float_typeof(), ::g::ObjC::Object_typeof());
    ::TYPES[2] = ::g::Uno::Predicate_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[3] = ::g::Fuse::Resources::SystemFileSource_typeof();
    ::TYPES[4] = ::g::Uno::UX::BundleFileSource_typeof();
    type->SetFields(0,
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Internal::FontFaceDescriptor_typeof(), ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Float_typeof(), ::g::ObjC::Object_typeof())), (uintptr_t)&::g::Fuse::Controls::Native::iOS::FontCache::_cache_, uFieldFlagsStatic);
}
...
// private static string BundleFilePath(string resource) :563
...
// private static string GetOptionalPath(Uno.UX.FileSource fileSource) :548
...
// private static ObjC.Object UIFontWithDescriptorAndSize(ObjC.Object descriptor, float size) :569
...
// private static string BundleFilePath(string resource) [static] :563
uString* FontCache::BundleFilePath(uString* resource)
{
    uStackFrame __("Fuse.Controls.Native.iOS.FontCache", "BundleFilePath(string)");
...
uObject* FontCache::Get(::g::Fuse::Internal::FontFaceDescriptor* descriptor, float size)
{
    ...
    {
        uObject* uifontdescriptor = ::g::Fuse::Internal::iOSSystemFont::GetMatchingUIFontDescriptor(path, uDelegate::New(::TYPES[2/*Uno.Predicate<string>*/], (void*)::g::Fuse::Internal::FontFaceDescriptor__Match_fn, uPtr(descriptor)));
    ...
    else 
    {
        ...
        uObject* uifontdescriptor1 = ::g::Fuse::Internal::iOSSystemFont::GetMatchingUIFontDescriptor(path, uDelegate::New(::TYPES[2/*Uno.Predicate<string>*/], (void*)::g::Fuse::Internal::FontFaceDescriptor__Match_fn, descriptor));
...
// private static string GetOptionalPath(Uno.UX.FileSource fileSource) [static] :548
...
// private static ObjC.Object UIFontWithDescriptorAndSize(ObjC.Object descriptor, float size) [static] :569
uObject* FontCache::UIFontWithDescriptorAndSize(uObject* descriptor, float size)
{
    uStackFrame __("Fuse.Controls.Native.iOS.FontCache", "UIFontWithDescriptorAndSize(ObjC.Object,float)");
    FontCache_typeof()->Init();
    @autoreleasepool
    {
