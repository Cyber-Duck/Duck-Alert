...
// internal sealed extern class Rectangle :1716
// {
...
// public Rectangle(Fuse.Visual visual) :1719
void Rectangle__ctor_2_fn(Rectangle* __this, ::g::Fuse::Visual* visual)
{
    __this->ctor_2(visual);
}

// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) :1805
...
// private static ObjC.Object CreateUIBezierPath() :1778
void Rectangle__CreateUIBezierPath_fn(uObject** __retval)
{
    *__retval = Rectangle::CreateUIBezierPath();
}

// private void Fuse.Controls.Native.IRectangleView.set_CornerRadius(float4 value) :1727
...
// private void MoveToPoint(ObjC.Object handle, float x, float y) :1791
void Rectangle__MoveToPoint_fn(Rectangle* __this, uObject* handle, float* x, float* y)
{
    __this->MoveToPoint(handle, *x, *y);
}

// public Rectangle New(Fuse.Visual visual) :1719
void Rectangle__New1_fn(::g::Fuse::Visual* visual, Rectangle** __retval)
{
    *__retval = Rectangle::New1(visual);
}

// public Rectangle(Fuse.Visual visual) [instance] :1719
void Rectangle::ctor_2(::g::Fuse::Visual* visual)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Rectangle", ".ctor(Fuse.Visual)");
    _cornerRadius = ::g::Uno::Float4__New1(0.0f);
    ctor_1(visual);
}

// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) [instance] :1805
void Rectangle::AddArcWithCenter(uObject* handle, float centerX, float centerY, float radius, float startAngle, float endAngle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Rectangle", "AddArcWithCenter(ObjC.Object,float,float,float,float,float)");
    @autoreleasepool
    {
...
// private void AddLineToPoint(ObjC.Object handle, float x, float y) [instance] :1798
void Rectangle::AddLineToPoint(uObject* handle, float x, float y)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Rectangle", "AddLineToPoint(ObjC.Object,float,float)");
    @autoreleasepool
    {
...
// private void ClosePath(ObjC.Object handle) [instance] :1784
void Rectangle::ClosePath(uObject* handle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Rectangle", "ClosePath(ObjC.Object)");
    @autoreleasepool
    {
        [] (::id handle) -> void
        {
...
// private void MoveToPoint(ObjC.Object handle, float x, float y) [instance] :1791
void Rectangle::MoveToPoint(uObject* handle, float x, float y)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Rectangle", "MoveToPoint(ObjC.Object,float,float)");
    @autoreleasepool
    {
        [] (::id handle, float x, float y) -> void
        {
...
// private static ObjC.Object CreateUIBezierPath() [static] :1778
uObject* Rectangle::CreateUIBezierPath()
{
    uStackFrame __("Fuse.Controls.Native.iOS.Rectangle", "CreateUIBezierPath()");
    @autoreleasepool
    {
...
// public Rectangle New(Fuse.Visual visual) [static] :1719
