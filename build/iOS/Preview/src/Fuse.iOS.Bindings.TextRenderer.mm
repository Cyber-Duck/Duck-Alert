...
{
    uStackFrame __("Fuse.iOS.Bindings.TextRenderer", "CGBitmapContextCreate(Uno.IntPtr,int,int,Fuse.iOS.Bindings.CGColorSpaceRef)");
...
{
    uStackFrame __("Fuse.iOS.Bindings.TextRenderer", "CGColorSpaceCreateDeviceRGB()");
    TextRenderer_typeof()->Init();
...
{
    uStackFrame __("Fuse.iOS.Bindings.TextRenderer", "CGContextRelease(Fuse.iOS.Bindings.CGContextRef)");
    TextRenderer_typeof()->Init();
...
{
    uStackFrame __("Fuse.iOS.Bindings.TextRenderer", "DrawGlyphs(Fuse.iOS.Bindings.CGContextRef,float,float,int,int,ObjC.Object,ObjC.Object)");
    TextRenderer_typeof()->Init();
    @autoreleasepool
    {
