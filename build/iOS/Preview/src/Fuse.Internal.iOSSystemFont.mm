...
// internal static extern class iOSSystemFont :1206
// {
// static iOSSystemFont() :1206
...
static void iOSSystemFont_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Collections::HashSet_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[2] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Internal::FontFaceDescriptor_typeof());
    ...
    type->SetFields(0,
        ::g::Uno::Collections::HashSet_typeof()->MakeType(::g::Uno::String_typeof()), (uintptr_t)&::g::Fuse::Internal::iOSSystemFont::_families_, uFieldFlagsStatic,
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof()), (uintptr_t)&::g::Fuse::Internal::iOSSystemFont::_fontPaths_, uFieldFlagsStatic,
        ::g::Uno::String_typeof()->Array(), (uintptr_t)&::g::Fuse::Internal::iOSSystemFont::_weightNames_, uFieldFlagsStatic);
}
...
// private static ObjC.Object GetDefaultUIFontDescriptor() :1324
void iOSSystemFont__GetDefaultUIFontDescriptor_fn(uObject** __retval)
{
    *__retval = iOSSystemFont::GetDefaultUIFontDescriptor();
}

// private static string GetDescriptorFontName(ObjC.Object descriptor) :1318
...
// private static ObjC.Object[] GetDescriptors(string fileName) :1515
void iOSSystemFont__GetDescriptors_fn(uString* fileName, uArray** __retval)
{
    *__retval = iOSSystemFont::GetDescriptors(fileName);
}

// private static Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> GetDescriptorsFromFontNames(string[] fontNames) :1257
...
// public static Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> GetFallback(Uno.UX.FileSource file) :1233
...
// private static ObjC.Object[] GetFallbackUIFontDescriptors(ObjC.Object rawDescriptor) :1354
...
// private static string[] GetFontNamesFromUIFontDescriptors(ObjC.Object[] descriptors) :1307
...
// private static Uno.Collections.IEnumerable<string> GetFontNameStyles(string fontName) :1272
...
// private static ObjC.Object GetMatchingFontDescriptor(string family, bool isItalic, string weight) :1337
...
// public static ObjC.Object GetMatchingUIFontDescriptor(string fileName, Uno.Predicate<string> stylePredicate) :1501
void iOSSystemFont__GetMatchingUIFontDescriptor_fn(uString* fileName, uDelegate* stylePredicate, uObject** __retval)
{
    *__retval = iOSSystemFont::GetMatchingUIFontDescriptor(fileName, stylePredicate);
}

// private static string GetPostscriptName(ObjC.Object descriptor) :1546
...
// private static string GetStyleName(ObjC.Object descriptor) :1536
...
// private static void AddFamily(string name) [static] :1492
...
// private static void AddFontPath(string name, string path) [static] :1484
...
// private static void AddFontPaths() [static] :1403
void iOSSystemFont::AddFontPaths()
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "AddFontPaths()");
    iOSSystemFont_typeof()->Init();
    @autoreleasepool
    {
...
// private static void EnsureFontPathsAdded() [static] :1392
void iOSSystemFont::EnsureFontPathsAdded()
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "EnsureFontPathsAdded()");
    iOSSystemFont_typeof()->Init();
...
// public static Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> Get(string family, Fuse.SystemFont.Style style, Fuse.SystemFont.Weight weight) [static] :1241
...
// private static ObjC.Object GetDefaultUIFontDescriptor() [static] :1324
uObject* iOSSystemFont::GetDefaultUIFontDescriptor()
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "GetDefaultUIFontDescriptor()");
    iOSSystemFont_typeof()->Init();
    @autoreleasepool
    {
...
// private static string GetDescriptorFontName(ObjC.Object descriptor) [static] :1318
uString* iOSSystemFont::GetDescriptorFontName(uObject* descriptor)
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "GetDescriptorFontName(ObjC.Object)");
    iOSSystemFont_typeof()->Init();
    @autoreleasepool
    {
...
// private static ObjC.Object[] GetDescriptors(string fileName) [static] :1515
uArray* iOSSystemFont::GetDescriptors(uString* fileName)
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "GetDescriptors(string)");
    iOSSystemFont_typeof()->Init();
    @autoreleasepool
    {
...
// private static Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> GetDescriptorsFromFontNames(string[] fontNames) [static] :1257
::g::Uno::Collections::List* iOSSystemFont::GetDescriptorsFromFontNames(uArray* fontNames)
{
    ...
    for (array1 = fontNames, index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        if ((::g::Uno::String::op_Inequality(fontName, NULL) && (::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(iOSSystemFont::FontPaths()), fontName, (void**)(&path), &ret10), ret10)) && ::g::Uno::IO::File::Exists(path))
            ::g::Uno::Collections::List__Add_fn(uPtr(result), ::g::Fuse::Internal::FontFaceDescriptor::New1(::g::Fuse::Resources::SystemFileSource::New1(path), iOSSystemFont::GetFontNameStyles(fontName)));
    }

    return result;
}

// public static Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> GetFallback(Uno.UX.FileSource file) [static] :1233
::g::Uno::Collections::List* iOSSystemFont::GetFallback(::g::Uno::UX::FileSource* file)
{
    ...
    iOSSystemFont_typeof()->Init();
    ::g::Uno::Collections::List* result = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[3/*Uno.Collections.List<Fuse.Internal.FontFaceDescriptor>*/]);
    ::g::Uno::Collections::List__Add_fn(result, ::g::Fuse::Internal::FontFaceDescriptor::New1(file, (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[4/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], uArray::New(::TYPES[0/*string[]*/], 0)))));
    result->AddRange((uObject*)iOSSystemFont::Get(NULL, 0, 3));
    return result;
}

// private static ObjC.Object[] GetFallbackUIFontDescriptors(ObjC.Object rawDescriptor) [static] :1354
uArray* iOSSystemFont::GetFallbackUIFontDescriptors(uObject* rawDescriptor)
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "GetFallbackUIFontDescriptors(ObjC.Object)");
    iOSSystemFont_typeof()->Init();
    @autoreleasepool
    {
...
// private static string[] GetFontNamesFromUIFontDescriptors(ObjC.Object[] descriptors) [static] :1307
...
// private static Uno.Collections.IEnumerable<string> GetFontNameStyles(string fontName) [static] :1272
uObject* iOSSystemFont::GetFontNameStyles(uString* fontName)
{
    ...
    iOSSystemFont_typeof()->Init();
    ::g::Uno::Collections::List* result = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[5/*Uno.Collections.List<string>*/]);
...
// private static ObjC.Object GetMatchingFontDescriptor(string family, bool isItalic, string weight) [static] :1337
uObject* iOSSystemFont::GetMatchingFontDescriptor(uString* family, bool isItalic, uString* weight)
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "GetMatchingFontDescriptor(string,bool,string)");
    iOSSystemFont_typeof()->Init();
    @autoreleasepool
    {
...
// public static ObjC.Object GetMatchingUIFontDescriptor(string fileName, Uno.Predicate<string> stylePredicate) [static] :1501
uObject* iOSSystemFont::GetMatchingUIFontDescriptor(uString* fileName, uDelegate* stylePredicate)
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "GetMatchingUIFontDescriptor(string,Uno.Predicate<string>)");
    iOSSystemFont_typeof()->Init();
    bool ret11;
...
// private static string GetPostscriptName(ObjC.Object descriptor) [static] :1546
uString* iOSSystemFont::GetPostscriptName(uObject* descriptor)
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "GetPostscriptName(ObjC.Object)");
    iOSSystemFont_typeof()->Init();
    @autoreleasepool
    {
        return ::uObjC::UnoString([] (::id descriptor) -> ::NSString*
...
// private static string GetStyleName(ObjC.Object descriptor) [static] :1536
...
// public static Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> get_Default() [static] :1215
...
// public static Uno.Collections.HashSet<string> get_Families() [static] :1226
::g::Uno::Collections::HashSet* iOSSystemFont::Families()
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "get_Families()");
    iOSSystemFont_typeof()->Init();
    iOSSystemFont::EnsureFontPathsAdded();
    return iOSSystemFont::_families();
}

// private static Uno.Collections.Dictionary<string, string> get_FontPaths() [static] :1385
::g::Uno::Collections::Dictionary* iOSSystemFont::FontPaths()
{
    uStackFrame __("Fuse.Internal.iOSSystemFont", "get_FontPaths()");
    iOSSystemFont_typeof()->Init();
    iOSSystemFont::EnsureFontPathsAdded();
