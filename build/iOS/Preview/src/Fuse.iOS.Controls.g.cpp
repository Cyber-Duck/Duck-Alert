...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/0.40.8/ios/$.uno
// --------------------------------------------------------------------
...
static void WebView_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.WebView/0.40.8/ios/$.uno");
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[1] = ::g::Uno::Exception_typeof();
    ::TYPES[2] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::Double_typeof());
...
{
    uStackFrame __("Fuse.iOS.Controls.WebView", "get_Loading()");
