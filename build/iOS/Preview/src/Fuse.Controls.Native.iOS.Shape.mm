...
// internal abstract extern class Shape :1993
// {
static void Shape_build(uType* type)
{
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/0.40.8/ios/$.uno");
...
// protected Shape(Fuse.Visual visual) :1998
void Shape__ctor_1_fn(Shape* __this, ::g::Fuse::Visual* visual)
{
    __this->ctor_1(visual);
}

// private static ObjC.Object Create() :2238
...
// private void Fuse.Controls.Native.IShapeView.Update(Fuse.Drawing.Brush[] fills, Fuse.Drawing.Stroke[] strokes, float pixelsPerPoint) :2034
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) :2222
void Shape__MakeLayers_fn(uObject* handle, int* layerCount)
{
    Shape::MakeLayers(handle, *layerCount);
}

// protected void OnShapeChanged() :2040
void Shape__OnShapeChanged_fn(Shape* __this)
{
    __this->OnShapeChanged();
}

// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) :2092
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) :2068
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) :2200
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) :2097
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) :2129
...
// public override sealed void set_Transform(float4x4 value) :2013
...
// protected Shape(Fuse.Visual visual) [instance] :1998
...
// protected void OnShapeChanged() [instance] :2040
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :2068
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int layer, uObject* path, bool isLine, float strokeWidth)
{
    ...
    else 
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"/usr/local/...*/], 2085, ::STRINGS[2/*"SetBrush"*/]);
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :2097
...
// protected generated float2 get_ShapePosition() [instance] :2010
::g::Uno::Float2 Shape::ShapePosition()
{
    uStackFrame __("Fuse.Controls.Native.iOS.Shape", "get_ShapePosition()");
    return _ShapePosition;
}

// private generated void set_ShapePosition(float2 value) [instance] :2010
void Shape::ShapePosition(::g::Uno::Float2 value)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Shape", "set_ShapePosition(float2)");
    _ShapePosition = value;
}

// protected generated float2 get_ShapeSize() [instance] :2021
::g::Uno::Float2 Shape::ShapeSize()
{
    uStackFrame __("Fuse.Controls.Native.iOS.Shape", "get_ShapeSize()");
    return _ShapeSize;
}

// private generated void set_ShapeSize(float2 value) [instance] :2021
void Shape::ShapeSize(::g::Uno::Float2 value)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Shape", "set_ShapeSize(float2)");
    _ShapeSize = value;
}

// private static ObjC.Object Create() [static] :2238
uObject* Shape::Create()
{
    uStackFrame __("Fuse.Controls.Native.iOS.Shape", "Create()");
    @autoreleasepool
    {
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) [static] :2222
void Shape::MakeLayers(uObject* handle, int layerCount)
{
    uStackFrame __("Fuse.Controls.Native.iOS.Shape", "MakeLayers(ObjC.Object,int)");
    @autoreleasepool
    {
...
// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) [static] :2092
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) [static] :2200
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.Shape", "SetBrush(ObjC.Object,float,float,float,float,int,ObjC.Object,bool,float,float)");
    @autoreleasepool
    {
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) [static] :2129
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.Shape", "SetLinearGradient(ObjC.Object,int,ObjC.Object,bool,float,float,float,float,float,float[],float[],float,float)");
    @autoreleasepool
    {
