...
{
    uStackFrame __("Fuse.Controls.Native.iOS.Circle", "CreatePath()");
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.Circle", ".ctor(Fuse.Visual)");
    ctor_1(visual);
}
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.Circle", "CreateUIBezierPath(float,float,float,float,float)");
    @autoreleasepool
    {
