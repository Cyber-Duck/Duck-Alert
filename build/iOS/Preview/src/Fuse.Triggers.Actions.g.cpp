...
// /usr/local/share/uno/Packages/Fuse.Elements/0.40.8/triggers/actions/$.uno
// -------------------------------------------------------------------------
...
// public generated Collapse() :1003
void Collapse__ctor_2_fn(Collapse* __this)
{
    __this->ctor_2();
}

// public generated Collapse New() :1003
...
// public generated Collapse() [instance] :1003
...
// public generated Collapse New() [static] :1003
...
static void DebugAction_build(uType* type)
{
    ...
    ::TYPES[6] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Triggers::Actions::ITaggedDebugProperty_typeof());
    type->SetFields(8,
...
// public generated Hide() :971
void Hide__ctor_2_fn(Hide* __this)
{
    __this->ctor_2();
}

// public generated Hide New() :971
...
// public generated Hide() [instance] :971
void Hide::ctor_2()
{
...
// public generated Hide New() [static] :971
Hide* Hide::New2()
{
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.40.8/$.uno");
    ::STRINGS[9] = uString::Const("Perform");
    ::TYPES[14] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[15] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[16] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ...
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[19] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    type->SetFields(8,
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[7/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[8/*"/usr/local/...*/], 240, ::STRINGS[9/*"Perform"*/]);
    else 
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/0.40.8/$.uno");
    ::STRINGS[9] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[20] = ::g::Fuse::Controls::Navigator_typeof();
    ::TYPES[21] = ::g::Uno::Action_typeof();
    type->SetFields(8,
        ::g::Fuse::Controls::Navigator_typeof(), offsetof(::g::Fuse::Triggers::Actions::ReleasePage, _pendNavigator), 0,
        ::g::Fuse::Visual_typeof(), offsetof(::g::Fuse::Triggers::Actions::ReleasePage, _pendVisual), 0);
    type->Reflection.SetFunctions(1,
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"Requires a ...*/], __this, ::STRINGS[11/*"/usr/local/...*/], 285, ::STRINGS[9/*"Perform"*/]);
        return;
    }
...
// public generated Show() :939
void Show__ctor_2_fn(Show* __this)
{
    __this->ctor_2();
}

// public generated Show New() :939
...
// public generated Show() [instance] :939
void Show::ctor_2()
{
...
// public generated Show New() [static] :939
Show* Show::New2()
{
...
// public float get_AtProgress() [instance] :857
...
// public void set_AtProgress(float value) [instance] :858
...
{
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[26] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Controls::WebView_typeof());
    type->SetFields(8);
}
