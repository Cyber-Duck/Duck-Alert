...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/0.40.8/ios/$.uno
// -------------------------------------------------------------------
...
// internal sealed extern class iOSBlitter :1671
// {
// static iOSBlitter() :1671
...
static void iOSBlitter_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Float2_typeof()->Array(), offsetof(::g::Fuse::Controls::Native::iOS::iOSBlitter, Blit_verts_fbdb836b_3_3_5), 0,
...
// public generated iOSBlitter() :1671
void iOSBlitter__ctor__fn(iOSBlitter* __this)
{
    __this->ctor_();
}

// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) :1675
...
// private generated void init_DrawCalls() :1671
void iOSBlitter__init_DrawCalls_fn(iOSBlitter* __this)
{
    __this->init_DrawCalls();
}

// public generated iOSBlitter New() :1671
...
// public generated iOSBlitter() [instance] :1671
...
// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) [instance] :1675
...
// private generated void init_DrawCalls() [instance] :1671
...
// public generated iOSBlitter New() [static] :1671
...
// public sealed extern class OSVersion :1296
// {
...
// public OSVersion(int major, int minor, int patch) :1301
void OSVersion__ctor__fn(OSVersion* __this, int* major, int* minor, int* patch)
{
    __this->ctor_(*major, *minor, *patch);
}

// public OSVersion New(int major, int minor, int patch) :1301
...
// public OSVersion(int major, int minor, int patch) [instance] :1301
...
// public OSVersion New(int major, int minor, int patch) [static] :1301
...
// public enum iOSDevice.ScreenOrientation :1316
...
// public enum UITouch.TouchPhase :1140
...
// public abstract extern class ViewParent :3637
// {
...
// protected ViewParent(ObjC.Object handle) :3639
void ViewParent__ctor_1_fn(ViewParent* __this, uObject* handle)
{
    __this->ctor_1(handle);
}

// protected ViewParent(ObjC.Object handle) [instance] :3639
