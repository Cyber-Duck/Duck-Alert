...
// public abstract extern class LeafView :1460
// {
...
// protected LeafView(ObjC.Object handle) :1463
void LeafView__ctor_1_fn(LeafView* __this, uObject* handle)
{
    __this->ctor_1(handle);
}

// public float2 Measure(Fuse.LayoutParams lp, float density) :1465
...
// private static void SizeThatFits(ObjC.Object handle, float w, float h, float& resW, float& resH) :1484
...
// protected LeafView(ObjC.Object handle) [instance] :1463
...
// public float2 Measure(Fuse.LayoutParams lp, float density) [instance] :1465
...
// private static void SizeThatFits(ObjC.Object handle, float w, float h, float& resW, float& resH) [static] :1484
