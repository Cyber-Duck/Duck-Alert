...
// internal sealed extern class ImageView :693
// {
...
// public void set_TintColor(float4 value) :717
void ImageView__set_TintColor_fn(ImageView* __this, ::g::Uno::Float4* value)
{
    __this->TintColor(*value);
}

// private static ObjC.Object TintImage(ObjC.Object handle, float r, float g, float b, float a) :838
...
// private void UpdateImage() :724
void ImageView__UpdateImage_fn(ImageView* __this)
{
    __this->UpdateImage();
}

// private void UpdateImage(Fuse.Resources.FileImageSource fileImageSource) :770
...
// private void UpdateImage(Fuse.Resources.HttpImageSource http) :775
void ImageView__UpdateImage2_fn(ImageView* __this, ::g::Fuse::Resources::HttpImageSource* http)
{
    __this->UpdateImage2(http);
}

// private void UpdateImage(Fuse.Resources.MultiDensityImageSource multi) :790
void ImageView__UpdateImage3_fn(ImageView* __this, ::g::Fuse::Resources::MultiDensityImageSource* multi)
{
    __this->UpdateImage3(multi);
}

// public void UpdateImageTransform(float density, float2 origin, float2 scale, float2 drawSize) :795
...
// public ImageView(Fuse.Visual visual) [instance] :732
...
// private float2 GetImageSize() [instance] :804
::g::Uno::Float2 ImageView::GetImageSize()
{
    uStackFrame __("Fuse.Controls.Native.iOS.ImageView", "GetImageSize()");
    return ::g::Uno::Float2__New2(ImageView::GetImageWidth(_uiImageView), ImageView::GetImageHeight(_uiImageView));
}

// private void set_ImageHandle(Fuse.Controls.Native.ImageHandle value) [instance] :751
...
// public void set_ImageSource(Fuse.Resources.ImageSource value) [instance] :697
...
// private void OnImageLoaded(Fuse.Controls.Native.ImageHandle handle) [instance] :780
...
// private void OnImageLoadFailed(Uno.Exception e) [instance] :785
...
// public void set_TintColor(float4 value) [instance] :717
void ImageView::TintColor(::g::Uno::Float4 value)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ImageView", "set_TintColor(float4)");
    _tintColor = value;
    UpdateImage();
}

// private void UpdateImage() [instance] :724
void ImageView::UpdateImage()
{
    uStackFrame __("Fuse.Controls.Native.iOS.ImageView", "UpdateImage()");
    ::g::Uno::Float4 c = _tintColor;
    ImageView::SetImage(_uiImageView, ImageView::TintImage(_uiImageHandle, c.X, c.Y, c.Z, c.W));
}

// private void UpdateImage(Fuse.Resources.FileImageSource fileImageSource) [instance] :770
...
// private void UpdateImage(Fuse.Resources.HttpImageSource http) [instance] :775
...
// private void UpdateImage(Fuse.Resources.MultiDensityImageSource multi) [instance] :790
...
// public void UpdateImageTransform(float density, float2 origin, float2 scale, float2 drawSize) [instance] :795
...
// private static void ClearImage(ObjC.Object imageViewHandle) [static] :858
void ImageView::ClearImage(uObject* imageViewHandle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ImageView", "ClearImage(ObjC.Object)");
    @autoreleasepool
    {
...
// private static ObjC.Object Create() [static] :865
...
// private static ObjC.Object CreateImageView(ObjC.Object container) [static] :876
...
// private static float GetImageHeight(ObjC.Object handle) [static] :821
float ImageView::GetImageHeight(uObject* handle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ImageView", "GetImageHeight(ObjC.Object)");
    @autoreleasepool
    {
...
// private static float GetImageWidth(ObjC.Object handle) [static] :812
float ImageView::GetImageWidth(uObject* handle)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ImageView", "GetImageWidth(ObjC.Object)");
    @autoreleasepool
    {
        return [] (::id handle) -> float
        {
...
// public ImageView New(Fuse.Visual visual) [static] :732
...
// private static void SetImage(ObjC.Object imageViewHandle, ObjC.Object uiImageHandle) [static] :830
...
// private static ObjC.Object TintImage(ObjC.Object handle, float r, float g, float b, float a) [static] :838
uObject* ImageView::TintImage(uObject* handle, float r, float g, float b, float a)
{
    uStackFrame __("Fuse.Controls.Native.iOS.ImageView", "TintImage(ObjC.Object,float,float,float,float)");
    @autoreleasepool
    {
