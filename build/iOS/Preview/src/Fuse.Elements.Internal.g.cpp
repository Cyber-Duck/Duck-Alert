...
void ElementDraw::init_DrawCalls()
{
    ...
    _draw_ecf1769 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControls_bundle::SolidRectangled1bbfcb0());
}
...
static void Scale9Rectangle_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::UShort_typeof()->Array(), offsetof(::g::Fuse::Elements::Internal::Scale9Rectangle, Draw_indices_42808b82_1_2_13), 0,
