...
{
    uStackFrame __("Fuse.iOS.Bindings.iOSDeviceInterop", "IsRootView(ObjC.Object)");
    @autoreleasepool
    {
...
{
    uStackFrame __("Fuse.iOS.Bindings.iOSDeviceInterop", "Pre_iOS8_HandleDeviceOrientation(float2,ObjC.Object)");
...
{
    uStackFrame __("Fuse.iOS.Bindings.iOSDeviceInterop", "Pre_iOS8_HandleDeviceOrientation(Uno.Rect,ObjC.Object)");
