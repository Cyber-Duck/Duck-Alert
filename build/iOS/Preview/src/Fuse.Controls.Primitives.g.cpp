...
static void ShadowElement_build(uType* type)
{
    ...
    type->SetFields(87,
        ::g::Fuse::Controls::Circle_typeof(), offsetof(::g::Fuse::Controls::Primitives::ShadowElement, _circleParent), 0,
        ...
        ::g::Fuse::Controls::Rectangle_typeof(), offsetof(::g::Fuse::Controls::Primitives::ShadowElement, _rectangleParent), 0,
...
{
    uStackFrame __("Fuse.Controls.Primitives.ShadowElement", ".ctor()");
...
{
    uStackFrame __("Fuse.Controls.Primitives.ShadowElement", "get_Color()");
    return _color;
}
...
{
    uStackFrame __("Fuse.Controls.Primitives.ShadowElement", "get_MaxSize()");
...
{
    uStackFrame __("Fuse.Controls.Primitives.ShadowElement", "get_Size()");
    return _size;
}
...
{
    uStackFrame __("Fuse.Controls.Primitives.ShadowElement", "get_Smoothness()");
