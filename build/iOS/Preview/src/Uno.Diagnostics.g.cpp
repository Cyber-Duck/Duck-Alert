...
// /usr/local/share/uno/Packages/UnoCore/0.40.2/source/uno/diagnostics/$.uno
// -------------------------------------------------------------------------
...
{
    ::TYPES[2] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Diagnostics::ProfileEvent_typeof());
    ::TYPES[4] = ::g::Uno::Diagnostics::IdMap_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetFields(0,
