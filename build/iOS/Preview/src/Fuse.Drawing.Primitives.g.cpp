...
// /usr/local/share/uno/Packages/Fuse.Drawing.Primitives/0.40.8/$.uno
// ------------------------------------------------------------------
...
// internal sealed class ConcaveWedgeCoverage :762
// {
...
// public generated ConcaveWedgeCoverage New() [static] :762
...
// internal sealed class ConvexWedgeCoverage :757
// {
...
// public generated ConvexWedgeCoverage New() [static] :757
...
// internal abstract class Coverage :348
// {
...
// protected generated Coverage() :348
void Coverage__ctor__fn(Coverage* __this)
{
    __this->ctor_();
}

// protected generated Coverage() [instance] :348
void Coverage::ctor_()
{
}
// }
...
// public generated Falloff() :367
void Falloff__ctor__fn(Falloff* __this)
{
    __this->ctor_();
}

// public generated Falloff New() :367
void Falloff__New1_fn(Falloff** __retval)
{
    *__retval = Falloff::New1();
}

// public generated Falloff() [instance] :367
void Falloff::ctor_()
{
}

// public generated Falloff New() [static] :367
...
// internal sealed class FillCoverage :352
// {
...
// public generated FillCoverage New() [static] :352
...
// public sealed class Rectangle :379
// {
// static Rectangle() :379
...
// public generated Rectangle() :379
void Rectangle__ctor__fn(Rectangle* __this)
{
    __this->ctor_();
}

// private float[] add(float[] a, float[] b) :415
void Rectangle__add_fn(Rectangle* __this, uArray* a, uArray* b, uArray** __retval)
{
    *__retval = __this->add(a, b);
}

// private void Draw(Fuse.DrawContext dc, Fuse.Visual visual, float2 Size, float4 CornerRadius, Fuse.Drawing.Brush brush, Fuse.Drawing.Primitives.Coverage cover, float2 extend, float2 position, float smoothness, [Fuse.Drawing.Primitives.Falloff falloff]) :619
...
// public void Fill(Fuse.DrawContext dc, Fuse.Visual visual, float2 Size, float4 CornerRadius, Fuse.Drawing.Brush brush, [float2 Position], [float Smoothness]) :400
...
// private generated void init_DrawCalls() :379
void Rectangle__init_DrawCalls_fn(Rectangle* __this)
{
    __this->init_DrawCalls();
}

// private void InitBuffers() :450
void Rectangle__InitBuffers_fn(Rectangle* __this)
{
    __this->InitBuffers();
}

// private float[] neg(float[] a) :431
void Rectangle__neg_fn(Rectangle* __this, uArray* a, uArray** __retval)
{
    *__retval = __this->neg(a);
}

// public generated Rectangle New() :379
void Rectangle__New1_fn(Rectangle** __retval)
{
    *__retval = Rectangle::New1();
}

// public void Shadow(Fuse.DrawContext dc, Fuse.Visual visual, float2 Size, float4 CornerRadius, Fuse.Drawing.Brush brush, [float2 Position], [float Smoothness]) :408
...
// public void Stroke(Fuse.DrawContext dc, Fuse.Visual visual, float2 Size, float4 CornerRadius, Fuse.Drawing.Stroke stroke, [float2 Position], [float Smoothness]) :384
...
// private float[] sub(float[] a, float[] b) :423
...
// public generated Rectangle() [instance] :379
...
// private float[] add(float[] a, float[] b) [instance] :415
...
// private void Draw(Fuse.DrawContext dc, Fuse.Visual visual, float2 Size, float4 CornerRadius, Fuse.Drawing.Brush brush, Fuse.Drawing.Primitives.Coverage cover, float2 extend, float2 position, float smoothness, [Fuse.Drawing.Primitives.Falloff falloff]) [instance] :619
...
// public void Fill(Fuse.DrawContext dc, Fuse.Visual visual, float2 Size, float4 CornerRadius, Fuse.Drawing.Brush brush, [float2 Position], [float Smoothness]) [instance] :400
...
// private generated void init_DrawCalls() [instance] :379
...
// private void InitBuffers() [instance] :450
...
// private float[] neg(float[] a) [instance] :431
...
// public void Shadow(Fuse.DrawContext dc, Fuse.Visual visual, float2 Size, float4 CornerRadius, Fuse.Drawing.Brush brush, [float2 Position], [float Smoothness]) [instance] :408
...
// public void Stroke(Fuse.DrawContext dc, Fuse.Visual visual, float2 Size, float4 CornerRadius, Fuse.Drawing.Stroke stroke, [float2 Position], [float Smoothness]) [instance] :384
...
// private float[] sub(float[] a, float[] b) [instance] :423
...
// public generated Rectangle New() [static] :379
...
// internal sealed class ShadowFalloff :372
// {
...
// public generated ShadowFalloff New() [static] :372
...
// internal sealed class StrokeCoverage :358
// {
...
// public generated StrokeCoverage New() [static] :358
...
// public generated Wedge() :767
void Wedge__ctor__fn(Wedge* __this)
{
    __this->ctor_();
}

// public void Fill(Fuse.DrawContext dc, Fuse.Elements.Element node, float radius, Fuse.Drawing.Brush brush, float2 center, float startAngle, float endAngle, float smoothness) :808
...
// public generated Wedge New() :767
void Wedge__New1_fn(Wedge** __retval)
{
    *__retval = Wedge::New1();
}

// private Fuse.Drawing.Primitives.WedgeCoverage SetupWedgeCoverage(float startAngle, float endAngle) :774
...
// public void Stroke(Fuse.DrawContext dc, Fuse.Elements.Element node, float radius, Fuse.Drawing.Stroke stroke, float2 center, float startAngle, float endAngle, float smoothness) :791
...
// public generated Wedge() [instance] :767
void Wedge::ctor_()
{
...
// public void Fill(Fuse.DrawContext dc, Fuse.Elements.Element node, float radius, Fuse.Drawing.Brush brush, float2 center, float startAngle, float endAngle, float smoothness) [instance] :808
...
// private Fuse.Drawing.Primitives.WedgeCoverage SetupWedgeCoverage(float startAngle, float endAngle) [instance] :774
...
// public void Stroke(Fuse.DrawContext dc, Fuse.Elements.Element node, float radius, Fuse.Drawing.Stroke stroke, float2 center, float startAngle, float endAngle, float smoothness) [instance] :791
...
// public generated Wedge New() [static] :767
Wedge* Wedge::New1()
{
...
// internal abstract class WedgeCoverage :726
// {
...
// protected generated WedgeCoverage() :726
void WedgeCoverage__ctor_1_fn(WedgeCoverage* __this)
{
    __this->ctor_1();
}

// protected generated WedgeCoverage() [instance] :726
