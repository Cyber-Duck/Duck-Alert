...
static void DrawableViewGroup_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(4,
        ...
        new uFunction("Add", NULL, (void*)DrawableViewGroup__Add1_fn, 0, false, uVoid_typeof(), 2, ::g::Fuse::Controls::Native::iOS::View_typeof(), ::g::Uno::Int_typeof()),
        new uFunction(".ctor", NULL, (void*)DrawableViewGroup__New1_fn, 0, true, DrawableViewGroup_typeof(), 2, ::g::Fuse::Controls::Native::OffscreenRendering_typeof(), ::g::Fuse::Visual_typeof()),
...
{
    uStackFrame __("Fuse.Controls.Native.iOS.DrawableViewGroup", "Add(ObjC.Object,ObjC.Object,int)");
    @autoreleasepool
    {
