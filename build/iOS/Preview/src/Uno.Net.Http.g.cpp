...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.40.2/uriparsers/$.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.40.2/$.uno
// -------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("/usr/local/share/uno/Packages/Uno.Net.Http/0.40.2/$.uno");
...
static void HttpMessageHandler_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof());
    type->SetInterfaces(
...
static void HttpMessageHandlerRequest_build(uType* type)
{
    ...
    ::TYPES[10] = HttpMessageHandlerRequest__DispatchClosure1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[11] = ::g::Uno::Action1_typeof()->MakeType(HttpMessageHandlerRequest_typeof());
    ::TYPES[12] = ::g::Uno::Action2_typeof()->MakeType(HttpMessageHandlerRequest_typeof(), ::g::Uno::String_typeof());
    ::TYPES[13] = ::g::Uno::Action4_typeof()->MakeType(HttpMessageHandlerRequest_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof());
    type->SetInterfaces(
...
static void HttpStatusReasonPhrase_build(uType* type)
{
    ...
    ::TYPES[14] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof());
    ::TYPES[15] = ::g::Uno::Collections::IDictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
...
static void UriScheme_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[16] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Int_typeof());
    type->SetFields(0,
