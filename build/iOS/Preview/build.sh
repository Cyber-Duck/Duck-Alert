#!/bin/bash
# This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.40.2/targets/ios/build.sh.
...
##else
    xcodebuild -project "Duck-Alert.xcodeproj" "$@" | tee >(checkForError)
##endif
