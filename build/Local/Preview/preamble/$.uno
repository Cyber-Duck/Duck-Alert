...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("172.16.22.185"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124)}, "/Users/JLMacAir/development/hackathons/Duck-Alert/Duck-Alert.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("Duck-Alert");
}
}
}
